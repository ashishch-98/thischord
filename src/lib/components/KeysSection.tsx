  ...
  return (
    ...
    <Box>
      <Grid container spacing={2}>
        <Grid xs={6} md={6} textAlign={'left'} px={1} >
          <h2>Keys</h2>
        </Grid>
        <Grid xs={6} md={6} textAlign={'right'} alignSelf={'end'} py={3}>
        ...
        <Grid container spacing={{ xs: 3, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }} >
          {Array.from(Array(6)).map((_, index) => (
            <Grid item xs={2} sm={3} md={4} key={index} >
              <Card sx={{ display: 'flex' }} style={{background:'#000',borderRadius:'8px'}}>
                <Grid xs={9} sm={9} className={style.keyCards} alignSelf={'center'}>
                ...
                <Grid xs={3} sm={3} className={style.keyCards}>
                  <LibraryMusicIcon style={{  height: '100%' }} />
                </Grid>
                {/* <CardMedia>
                <LibraryMusicIcon style={{width:'100%', height:'100%'}} />
            </CardMedia> */}
              </Card>
            </Grid>
          ))}
